...
You wont be using these tools too often and primarily, if at all, as part of the "Advanced Uses" in part IV. There will need to be some extra configuring for that but that is explained in Part IV.
